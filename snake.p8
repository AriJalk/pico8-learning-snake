...
function update_input()
	local new_dir=nil
	for dir,key in pairs({right=➡️,left=⬅️,up=⬆️,down=⬇️}) do
		if btnp(key) then
			new_dir=directions[dir]
			break
		end
	end
	if new_dir and new_dir!=dir_buffer[#dir_buffer] and #dir_buffer<dir_buffer_cap then
		add(dir_buffer,new_dir)
	end
end
...
function update_snake()
	local new_dir=deli(dir_buffer,1)
 --make sure snake won't reverse
...

